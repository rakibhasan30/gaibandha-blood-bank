...
export default function DonorCard({ name, hospital, date, bloodGroup, timeAgo, onClick, photoUrl, showDonate = true }) {
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-2xl border border-gray-100 p-4 flex items-center gap-3 cursor-pointer hover:shadow-md transition-shadow duration-200"
    >
